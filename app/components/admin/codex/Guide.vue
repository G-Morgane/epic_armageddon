...
const recettes = [
  ...
  { cas: 'Armes de titan au choix (Reaver : 2 bras, 1 carapace)', comment: 'Ce sont des améliorations sans unité. Option « Armement de bras », type « Un choix parmi plusieurs » : une ligne par arme avec son coût (Poing de Combat 0, Canon Gatling 25, Canon Volcano 50…), règle « Au plus 2 fois par formation » pour les deux bras. Une arme unique (Multi-Laser de Carapace, 25 pts) : type « Arme, équipement ou règle spéciale ». Coche ensuite ces options sur la formation du titan dans l\'onglet Liste d\'armée. Pour que les armes possibles s\'affichent sous la ligne « 2x Armes de Bras » de la fiche : onglet Unités, « + armes au choix » sur cette ligne, puis l\'option et l\'emplacement (renseigne alors la catégorie et l\'emplacement de chaque arme de l\'option).' },
  ...
  { cas: 'Créer une liste de soutien partagée (Titans, aviation…)', comment: '« Nouvelle armée », choisis « Liste de soutien partagée ». Saisis ses unités et ses formations dans une seule section, sans budget : c\'est le codex qui l\'utilise qui fixe la limite (1/3 des points) via la règle de sa propre section. Elle n\'apparaît pas comme armée jouable ; une fois publiée, elle est proposée dans le sélecteur « Alliance » des autres codex.' },
  { cas: 'Mettre un mot en gras ou en italique', comment: 'Dans les textes libres (introduction, règles spéciales, notes) : **gras** et *italique*, ou __gras__ et _italique_. Un aperçu s\'affiche sous le champ des règles spéciales.' },
  { cas: 'Mettre l\'illustration de couverture', comment: 'Onglet Armée, carte « Couverture du PDF » : téléverser l\'image ou coller son adresse. Elle occupe toute la page de couverture, titre du codex et citation posés dessus sur un fond sombre. Sans image, la couverture garde son fond blanc. Utiliser une illustration nue : le titre est écrit par le site.' },
  { cas: 'Choisir ce que contient le PDF', comment: 'Bouton « Aperçu PDF » : cases Couverture, Profils d\'unité (une fiche par unité, à l\'ancienne) et Feuille de références, plus le sens Portrait ou Paysage. Les règles et la liste d\'armée sont toujours imprimées. L\'aperçu et le bouton de téléchargement suivent les cases cochées.' },
  { cas: 'Nommer les armes', comment: 'Pas besoin d\'un nom unique par arme : deux unités peuvent avoir un « Bolter Jumelé » avec des portées et des puissances différentes. Les suffixes hérités de l\'ancien tableur (« Bombardement (5) », « Bolter jumelé (AA+FrtF) ») peuvent être retirés.' },
