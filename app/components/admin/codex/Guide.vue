...
const recettes = [
  ...
  { cas: 'Mettre l\'illustration de couverture', comment: 'Onglet Armée, carte « Couverture du PDF » : téléverser l\'image ou coller son adresse. Les couvertures des anciens PDF portent déjà leur titre, on les laisse telles quelles. Pour une illustration nue, cocher « Incruster le bandeau et le titre ». Sans image, la couverture reste typographique.' },
